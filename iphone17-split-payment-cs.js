document.addEventListener('DOMContentLoaded', () => {
    ...
    submitBtn.addEventListener('click', () => {
        if (!selectedProduct || !selectedVariant || !selectedColor || !validateCustomerInfo() || !termsCheckbox.checked) {
            alert("Prosím, vyplňte všechna povinná pole a souhlaste s podmínkami.");
            return;
        }
        ...
        document.querySelector('.split-payment-calculator').innerHTML = `
            <div style="text-align: center; padding: 2rem;">
                ...
                <h2 style="color: #333;">Děkujeme za Vaši žádost!</h2>
                <p style="color: #555; font-size: 1.1rem;">Vaše žádost o financování byla úspěšně odeslána. Náš tým ji nyní posoudí a co nejdříve se vám ozveme s výsledkem.</p>
                <a href="index.html" class="btn btn-primary" style="margin-top: 2rem;">Zpět na hlavní stránku</a>
            </div>
        `;
    });
});
